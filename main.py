...
API_ID = int(os.getenv("TG_API_ID", "26033579"))
API_HASH = os.getenv("TG_API_HASH", "33a934bc26568850ed0eb2c829817090")
BOT_TOKEN = os.getenv("BOT_TOKEN", "7179045285:AAHcxS7OlewOOCBsq5hOJ8w_-TLl9tAm_P4")
